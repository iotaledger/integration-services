The [example-1](https://github.com/iotaledger/integration-services/blob/master/clients/client-sdk/examples/1-CreateIdentityAndCredential.ts)
...
## Authentication{#authentication-nodejs}
...
## Create an Identity{#create-an-identity-nodejs}
...
## Verify a Credential{#verify-a-credential-nodejs}
