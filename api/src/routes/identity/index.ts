...
import { UserSearch, UserType } from '@iota-is/shared-modules/src/models/types/user';
import { UserService } from '../../services/user-service';
import * as _ from 'lodash';
import { StatusCodes } from 'http-status-codes';
import { getDateFromString } from '../../utils/date';
import { AuthenticatedRequest } from '@iota-is/shared-modules/src/models/types/verification';
import { AuthorizationService } from '../../services/authorization-service';
import { CreateIdentityBody } from '@iota-is/shared-modules/src/models/types/identity';
import { IdentitySchemaBody } from '@iota-is/shared-modules/src/models/types/request-response-bodies';
