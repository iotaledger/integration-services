import { CredentialSubject } from '@iota-is/shared-modules/src/models/types/identity';
...
import { UserType, UserRoles } from '@iota-is/shared-modules/src/models/types/user';
