...
export function nextmsgid_identifier(a: number, b: number): void;
export function nextmsgid_link(a: number): number;
...
export function author_store_new_subscriber(a: number, b: number, c: number): void;
export function author_remove_subscriber(a: number, b: number, c: number): void;
export function author_remove_psk(a: number, b: number, c: number): void;
...
export function subscriber_recover(a: number, b: number, c: number, d: number): number;
...
export function subscriber_remove_psk(a: number, b: number, c: number): void;
...
export function _dyn_core__ops__function__FnMut__A____Output___R_as_wasm_bindgen__closure__WasmClosure___describe__invoke__h81d2a8c321411cc5(a: number, b: number, c: number): void;
export function __wbindgen_free(a: number, b: number): void;
export function __wbindgen_exn_store(a: number): void;
export function __wbindgen_add_to_stack_pointer(a: number): number;
export function wasm_bindgen__convert__closures__invoke2_mut__hcaf355ca835a5c8c(a: number, b: number, c: number, d: number): void;
