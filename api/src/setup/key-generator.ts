...
import { CreateIdentityBody, IdentityKeys } from '@iota-is/shared-modules/src/models/types/identity';
import { Subject, CredentialTypes } from '@iota-is/shared-modules/src/models/types/verification';
