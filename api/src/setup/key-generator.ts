...
import { CreateIdentityBody, IdentityKeys } from '@iota-is/shared-modules/models/types/identity';
import { Subject, CredentialTypes } from '@iota-is/shared-modules/models/types/verification';
