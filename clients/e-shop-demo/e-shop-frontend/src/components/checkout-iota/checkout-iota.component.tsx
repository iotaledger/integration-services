...
import { verifyCredential, readJSON, checkAge } from '../../services/verify-credential.service';
...
const CheckoutWithIota = () => {
	...
	const { setCredential, authenticated, isVerified, setIsVerified } = useContext(UserContext);
